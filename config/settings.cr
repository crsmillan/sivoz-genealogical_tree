...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "G Tree web application."
  #
  #
  ...
  #
  # settings.secret_key_base= g3xD8zLKjq8-Y5cvGX-B2OXt2Ce31pG0xaSGL-5oaiM
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("g_tree.log", "w"))
  #
  #
end
